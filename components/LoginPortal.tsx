...
// On utilise Eye et EyeOff pour l'icône de visualisation
...
export const LoginPortal: React.FC = () => {
  ...
  // Cet état gère si le texte est masqué (••••) ou visible (FSTI-202X)
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg("ACCÈS REFUSÉ. IDENTIFIANTS OU CODE FSTI INVALIDES.");
      
    } catch (err) {
      setErrorMsg("ERREUR DE LIAISON AVEC LE HUB.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[50px] p-10 border border-slate-100 dark:border-slate-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <form onSubmit={handleLogin} className="space-y-4 text-left mt-8">
            ...
            {/* PASSWORD / CODE FSTI AVEC VISUALISATION */}
            <div className="relative group">
              ...
              <input 
                required
                // La magie est ici : le type change dynamiquement
                type={showPassword ? "text" : "password"} 
                placeholder="Code FSTI ou Password" 
